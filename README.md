...
Each one being a one-stop class to find the utility method you are searching for by providing a static facade (see https://github.com/subes/invesdwin-norva#static-facade) to the most useful frameworks and providing its own set of operations which are missing from the ones that already exist.
