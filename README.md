...
This provides pools, threadlocals, adapters and wrappers for Random implementations. Consider using [CryptoRandomGenerators or StrongRandomGenerators](https://github.com/invesdwin/invesdwin-context-security/blob/master/README.md#crypto-module) where security is a concern.
