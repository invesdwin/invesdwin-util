...
import de.invesdwin.util.math.doubles.scaled.FPercentScale;

@Immutable
public abstract class AFDouble<E extends AFDouble<E>> extends Number implements Comparable<Object>, IDecimal {
    ...
    public static final ADelegateComparator<AFDouble<?>> COMPARATOR = new ADelegateComparator<AFDouble<?>>() {
        @Override
        protected Comparable<?> getCompareCriteria(final AFDouble<?> e) {
            return e;
        }
    };
    ...
    public int compareTo(final Object other) {
        ...
        if (other instanceof ADecimal) {
            ...
            doubleOther = cOther.getDefaultValue().doubleValueRaw();
    ...
    public Dfp dfpValue() {
        return de.invesdwin.util.math.decimal.internal.impl.DfpDecimalImplFactory.toDfp(getValue());
    }
    ...
    public int getDecimalDigits() {
        return new de.invesdwin.util.math.decimal.internal.impl.DecimalDigitsInfo(toString()).getDecimalDigits();
    }
    ...
    public int getWholeNumberDigits() {
        return new de.invesdwin.util.math.decimal.internal.impl.DecimalDigitsInfo(toString()).getWholeNumberDigits();
    }
    ...
    public int getDigits() {
        return new de.invesdwin.util.math.decimal.internal.impl.DecimalDigitsInfo(toString()).getDigits();
    }
    ...
    public E subtract(final AFDouble<E> subtrahend) {
        if (subtrahend == null) {
            return getGenericThis();
        }
        return newValueCopy(getValue() - subtrahend.doubleValue());
    }

    public E add(final AFDouble<E> augend) {
        if (augend == null) {
            return getGenericThis();
        }
        return newValueCopy(getValue() + augend.doubleValue());
    }

    public E multiply(final AFDouble<E> multiplicant) {
        if (isZero()) {
            return getGenericThis();
     ...
     */
    public E remainder(final AFDouble<E> divisor) {
        if (isZero()) {
            return getGenericThis();
     ...
     */
    public E divide(final AFDouble<E> divisor) {
        if (isZero()) {
            //prevent NaN
            return getGenericThis();
        } else if (divisor == null || divisor.isZero()) {
     ...
     */
    public E roundToStep(final AFDouble<E> step) {
        return roundToStep(step, DEFAULT_ROUNDING_MODE);
    }

    public E roundToStep(final AFDouble<E> step, final RoundingMode roundingMode) {
    ...
    public E pow(final AFDouble<E> exponent) {
    ...
    public E distance(final AFDouble<E> to) {
    ...
    public static <T extends AFDouble<T>> T zeroToNull(final T value) {
    ...
    public static <T extends AFDouble<T>> T sum(final T value1, final T value2) {
        if (value1 == null) {
            return value2;
        } else {
    ...
    public static <T extends AFDouble<T>> T max(final T value1, final T value2) {
        if (value1 == null) {
            return value2;
        } else {
    ...
    public static <T extends AFDouble<T>> T min(final T value1, final T value2) {
        if (value1 == null) {
            return value2;
        } else {
    ...
    public static <T extends AFDouble<T>> T negate(final T value) {
        if (value == null) {
            return null;
        } else {
            return value.negate();
    ...
    public static <T extends AFDouble<T>> T abs(final T value) {
        if (value == null) {
            return null;
        } else {
            return value.abs();
    ...
    public static <T extends AFDouble<T>> List<T> asListVector(final T[] vector) {
        if (vector == null) {
            return null;
        }
    ...
    public static <T extends AFDouble<T>> List<List<T>> asListMatrix(final T[][] matrix) {
        if (matrix == null) {
            return null;
        }
    ...
    public static <T extends AFDouble<T>> T[][] fixInconsistentMatrixDimensions(final T[][] matrix) {
        T missingValue = null;
    ...
    public static <T extends AFDouble<T>> List<? extends List<T>> fixInconsistentMatrixDimensionsAsList(
    ...
    public static <T extends AFDouble<T>> List<List<T>> fixInconsistentMatrixDimensionsAsList(
