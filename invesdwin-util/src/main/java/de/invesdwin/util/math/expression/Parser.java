...
import de.invesdwin.util.math.expression.eval.binary.AndOperation;
import de.invesdwin.util.math.expression.eval.binary.BinaryOperation;
import de.invesdwin.util.math.expression.eval.binary.CrossesAboveOperation;
import de.invesdwin.util.math.expression.eval.binary.CrossesBelowOperation;
import de.invesdwin.util.math.expression.eval.binary.NotOperation;
import de.invesdwin.util.math.expression.eval.binary.OrOperation;
