...
@NotThreadSafe
public class SliceDelegateLongLargeArray implements ILongLargeArray {

    private final ILongLargeArray delegate;
    private final long from;
    private final long length;

    public SliceDelegateLongLargeArray(final ILongLargeArray delegate, final long from, final long length) {
