...
public class UninitializedExpandableArrayBuffer implements MutableDirectBuffer {
    /**
    ...
    /**
     * Create an {@link UninitializedExpandableArrayBuffer} with an initial length of {@link #INITIAL_CAPACITY}.
     */
    public UninitializedExpandableArrayBuffer() {
        this(INITIAL_CAPACITY);
    }

    /**
     * Create an {@link UninitializedExpandableArrayBuffer} with a provided initial length.
     *
     * @param initialCapacity
     *            of the buffer.
     */
    public UninitializedExpandableArrayBuffer(final int initialCapacity) {
        byteArray = ByteBuffers.allocateByteArray(initialCapacity);
    }

    public UninitializedExpandableArrayBuffer(final byte[] byteArray) {
    ...
    public boolean equals(final Object obj) {
        ...
        final UninitializedExpandableArrayBuffer that = (UninitializedExpandableArrayBuffer) obj;
