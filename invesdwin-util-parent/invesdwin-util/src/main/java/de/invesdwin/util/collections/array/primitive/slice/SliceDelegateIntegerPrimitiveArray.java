...
@NotThreadSafe
public class SliceDelegateIntegerPrimitiveArray implements IIntegerPrimitiveArray {

    private final IIntegerPrimitiveArray delegate;
    private final int from;
    private final int length;

    public SliceDelegateIntegerPrimitiveArray(final IIntegerPrimitiveArray delegate, final int from, final int length) {
