...
import de.invesdwin.util.streams.buffer.memory.extend.internal.UnsafeMemory;

@NotThreadSafe
public class UnsafeMemoryBuffer extends UnsafeMemory implements IMemoryBuffer {
