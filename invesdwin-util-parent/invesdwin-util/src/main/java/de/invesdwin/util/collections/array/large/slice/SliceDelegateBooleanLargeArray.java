...
@NotThreadSafe
public class SliceDelegateBooleanLargeArray implements IBooleanLargeArray {

    private final IBooleanLargeArray delegate;
    private final long from;
    private final long length;

    public SliceDelegateBooleanLargeArray(final IBooleanLargeArray delegate, final long from, final long length) {
