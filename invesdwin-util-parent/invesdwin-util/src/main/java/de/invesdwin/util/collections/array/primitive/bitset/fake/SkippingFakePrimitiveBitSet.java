...
@Immutable
public final class SkippingFakePrimitiveBitSet implements IPrimitiveBitSet {

    private final ISkippingPrimitiveIndexProvider skippingIndexProvider;

    public SkippingFakePrimitiveBitSet(final ISkippingPrimitiveIndexProvider skippingIndexProvider) {
