...
@NotThreadSafe
public class SliceDelegateGenericPrimitiveArray<E> implements IGenericPrimitiveArray<E> {

    private final IGenericPrimitiveArray<E> delegate;
    private final int from;
    private final int length;

    public SliceDelegateGenericPrimitiveArray(final IGenericPrimitiveArray<E> delegate, final int from, final int length) {
