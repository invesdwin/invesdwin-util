...
@NotThreadSafe
public class SliceDelegateDoubleLargeArray implements IDoubleLargeArray {

    private final IDoubleLargeArray delegate;
    private final long from;
    private final long length;

    public SliceDelegateDoubleLargeArray(final IDoubleLargeArray delegate, final long from, final long length) {
