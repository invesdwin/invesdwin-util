...
public class Percent extends AScaledDecimal<Percent, PercentScale> {
    ...
    public static final Percent NINETYFIVE_PERCENT;
    public static final Percent NINETY_PERCENT;
    public static final Percent EIGHTY_PERCENT;
    public static final Percent SEVENTYFIVE_PERCENT;
    public static final Percent SEVENTY_PERCENT;
    public static final Percent SIXTY_PERCENT;
    public static final Percent FIFTY_PERCENT;
    public static final Percent FOURTY_PERCENT;
    public static final Percent THIRTY_PERCENT;
    public static final Percent TWENTYFIVE_PERCENT;
    public static final Percent TWENTY_PERCENT;
    ...
    static {
        ...
        NINETYFIVE_PERCENT = new Percent(95D, PercentScale.PERCENT);
        NINETY_PERCENT = new Percent(90D, PercentScale.PERCENT);
        EIGHTY_PERCENT = new Percent(80D, PercentScale.PERCENT);
        SEVENTYFIVE_PERCENT = new Percent(75D, PercentScale.PERCENT);
        SEVENTY_PERCENT = new Percent(70D, PercentScale.PERCENT);
        SIXTY_PERCENT = new Percent(60D, PercentScale.PERCENT);
        FIFTY_PERCENT = new Percent(50D, PercentScale.PERCENT);
        FOURTY_PERCENT = new Percent(40D, PercentScale.PERCENT);
        THIRTY_PERCENT = new Percent(30D, PercentScale.PERCENT);
        TWENTYFIVE_PERCENT = new Percent(25D, PercentScale.PERCENT);
        TWENTY_PERCENT = new Percent(20D, PercentScale.PERCENT);
    ...
    /**
     * Turns a rate of 1.1 into 0.9 and a rate of 0.9 into 1.1
     * 
