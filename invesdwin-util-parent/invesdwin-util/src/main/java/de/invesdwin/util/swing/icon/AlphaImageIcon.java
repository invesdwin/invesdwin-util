 ...
 * <P>
 * This class is suitable for wrapping an <CODE>ImageIcon</CODE> that holds an animated image. To show a non-animated
 * Icon with transparency, the companion class {@link AlphaIcon} is a lighter alternative.
 *
...
public class AlphaImageIcon extends ImageIcon {
    ...
    /**
     * Creates an <CODE>AlphaImageIcon</CODE> with the specified icon and opacity. The opacity <CODE>alpha</CODE> should
     * be in the range 0.0F (fully transparent) to 1.0F (fully opaque).
     *
     * @param icon
     *            the Icon to wrap
     * @param alpha
     ...
     * <P>
     * In common with <code>ImageIcom</code>, the newly set image will only be shown when the concerned component(s) are
     * repainted.
     *
     * @param image
    ...
    /**
     * Overridden to return the status of the image loading operation of a wrapped ImageIcon, or 0 if the contained icon
     * is not an ImageIcon.
     *
    ...
    /**
     * Overridden to return the ImageObserver of the image of a wrapped ImageIcon, or null if the contained icon is not
     * an ImageIcon.
     *
     * @return the loading status as defined by java.awt.MediaTracker
     */
    ...
    /**
     * Gets the width of the bounding rectangle of this <CODE>AlphaImageIcon</CODE>. Overridden to return the width of
     * the wrapped icom.
     *
    ...
    /**
     * Gets the height of the bounding rectangle of this <CODE>AlphaImageIcon</CODE>. Overridden to return the height of
     * the wrapped icon.
     *
