...
@ThreadSafe
public class ConcurrentBusyWaitingLong2FloatMap extends ConcurrentLong2FloatMap {
    public ConcurrentBusyWaitingLong2FloatMap(final int numBuckets, final int initialCapacity, final float loadFactor,
