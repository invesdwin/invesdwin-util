 ...
 */
@NotThreadSafe
public class NonClosingPooledFastByteArrayInputStream extends MeasurableInputStream implements RepositionableStream {
    ...
    public NonClosingPooledFastByteArrayInputStream(final PooledFastByteArrayOutputStream delegate) {
