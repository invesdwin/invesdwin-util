...
@Immutable
public abstract class ACombinedListsCallable<E> implements Callable<List<E>> {

    private final Callable<List<E>> higherPriority;
    private final Callable<List<E>> lowerPriority;

    public ACombinedListsCallable(final Callable<List<E>> higherPriority, final Callable<List<E>> lowerPriority) {
