...
public class LongArrayPrimitiveBitSetBase implements IPrimitiveArrayId {
    ...
    public LongArrayPrimitiveBitSetBase(final int size) {
        // nbits can't be negative; size 0 is OK
        if (size < 0) {
            throw new NegativeArraySizeException("nbits < 0: " + size);
        }

        words = ILongPrimitiveArray.newInstance(wordIndex(size - 1) + 1);
        this.size = size;
    }

    public LongArrayPrimitiveBitSetBase(final ILongPrimitiveArray words, final int size) {
        this.words = words;
        this.size = size;
    }
    ...
    public ILongPrimitiveArray getWords() {
        return words;
    }
    ...
    public void and(final LongArrayPrimitiveBitSetBase set) {
        if (this == set) {
            return;
        }
    ...
    public void or(final LongArrayPrimitiveBitSetBase set) {
        if (this == set) {
            return;
        }
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof LongArrayPrimitiveBitSetBase)) {
            return false;
        }
        final LongArrayPrimitiveBitSetBase set = (LongArrayPrimitiveBitSetBase) obj;
