...
public abstract class APropertyChangeSupportedBase {
    ...
    private static boolean equalsPropertyChangeListeners(final Object oldValue, final Object newValue) {
        final APropertyChangeSupportedBase cOldValue;
        if (oldValue instanceof APropertyChangeSupportedBase) {
            cOldValue = (APropertyChangeSupportedBase) oldValue;
        } else {
            cOldValue = null;
        }
        final APropertyChangeSupportedBase cNewValue;
        if (newValue instanceof APropertyChangeSupportedBase) {
            cNewValue = (APropertyChangeSupportedBase) newValue;
        } else {
            cNewValue = null;
        }
        //one of them null
