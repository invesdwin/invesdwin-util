...
public abstract class ATimeoutObjectPool<E> implements ICloseableObjectPool<E> {
    ...
    public static final IObjectPool<WrappedScheduledExecutorService> SCHEDULED_EXECUTOR_POOL = new AReferenceCountedObjectPool<WrappedScheduledExecutorService>() {
        ...
        protected WrappedScheduledExecutorService newObject() {
            ...
            return Executors.newScheduledThreadPool(ATimeoutObjectPool.class.getSimpleName() + "_SCHEDULED", 1)
    ...
    public ATimeoutObjectPool(final Duration timeout, final Duration checkInverval) {
        ...
        this.scheduledFuture = scheduledExecutor.scheduleAtFixedRate(this::checkTimeouts, 0, checkInverval.longValue(),
