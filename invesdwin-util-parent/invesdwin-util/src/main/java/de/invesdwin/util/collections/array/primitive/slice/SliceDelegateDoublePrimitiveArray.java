...
@NotThreadSafe
public class SliceDelegateDoublePrimitiveArray implements IDoublePrimitiveArray {

    private final IDoublePrimitiveArray delegate;
    private final int from;
    private final int length;

    public SliceDelegateDoublePrimitiveArray(final IDoublePrimitiveArray delegate, final int from, final int length) {
