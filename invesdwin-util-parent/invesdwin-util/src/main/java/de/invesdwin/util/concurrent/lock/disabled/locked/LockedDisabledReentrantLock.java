...
@Immutable
public class LockedDisabledReentrantLock extends LockedDisabledLock implements IReentrantLock {

    public static final LockedDisabledReentrantLock INSTANCE = new LockedDisabledReentrantLock();

    protected LockedDisabledReentrantLock() {}
