...
@NotThreadSafe
public class SliceDelegateLongPrimitiveArray implements ILongPrimitiveArray {

    private final ILongPrimitiveArray delegate;
    private final int from;
    private final int length;

    public SliceDelegateLongPrimitiveArray(final ILongPrimitiveArray delegate, final int from, final int length) {
