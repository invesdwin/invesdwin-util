...
public final class CheckedCastFloats {
    ...
    public static float[] checkedCastVector(final BitSet value) {
        if (value == null) {
            return null;
        }
    ...
    public static float[] checkedCastVector(final ADecimal<?>[] value) {
        if (value == null) {
            return null;
        }
        final float[] vector = new float[value.length];
    ...
    public static float[][] checkedCastMatrix(final BitSet[] value) {
        if (value == null) {
            return null;
        }
        final float[][] matrix = new float[value.length][];
    ...
    public static float[][] checkedCastMatrix(final ADecimal<?>[][] value) {
        if (value == null) {
            return null;
        }
        final float[][] matrix = new float[value.length][];
