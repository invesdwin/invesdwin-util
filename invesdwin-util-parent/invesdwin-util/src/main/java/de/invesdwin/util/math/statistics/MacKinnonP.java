...
public final class MacKinnonP {
    ...
    private static final Map<RegressionMethod, double[]> ADF_TAU_STAR = ILockCollectionFactory.getInstance(false)
            .newMap();
    private static final Map<RegressionMethod, double[]> ADF_TAU_MIN = ILockCollectionFactory.getInstance(false)
            .newMap();
    private static final Map<RegressionMethod, double[]> ADF_TAU_MAX = ILockCollectionFactory.getInstance(false)
            .newMap();
    private static final Map<RegressionMethod, double[][]> ADF_TAU_SMALLP = ILockCollectionFactory.getInstance(false)
            .newMap();
    private static final double[] ADF_LARGE_SCALING = new double[] { 1.0, 1e-1, 1e-1, 1e-2 };
    private static final Map<RegressionMethod, double[][]> ADF_TAU_LARGEP = ILockCollectionFactory.getInstance(false)
            .newMap();

    static {
        ADF_TAU_STAR.put(RegressionMethod.nc, new double[] { -1.04, -1.53, -2.68, -3.09, -3.07, -3.77 });
        ADF_TAU_STAR.put(RegressionMethod.c, new double[] { -1.61, -2.62, -3.13, -3.47, -3.78, -3.93 });
        ADF_TAU_STAR.put(RegressionMethod.ct, new double[] { -2.89, -3.19, -3.50, -3.65, -3.80, -4.36 });
        ADF_TAU_STAR.put(RegressionMethod.ctt, new double[] { -3.21, -3.51, -3.81, -3.83, -4.12, -4.63 });

        ADF_TAU_MIN.put(RegressionMethod.nc, new double[] { -19.04, -19.62, -21.21, -23.25, -21.63, -25.74 });
        ADF_TAU_MIN.put(RegressionMethod.c, new double[] { -18.83, -18.86, -23.48, -28.07, -25.96, -23.27 });
        ADF_TAU_MIN.put(RegressionMethod.ct, new double[] { -16.18, -21.15, -25.37, -26.63, -26.53, -26.18 });
        ADF_TAU_MIN.put(RegressionMethod.ctt, new double[] { -17.17, -21.1, -24.33, -24.03, -24.33, -28.22 });

        ADF_TAU_MAX.put(RegressionMethod.nc, new double[] { Double.POSITIVE_INFINITY, 1.51, 0.86, 0.88, 1.05, 1.24 });
        ADF_TAU_MAX.put(RegressionMethod.c, new double[] { 2.74, 0.92, 0.55, 0.61, 0.79, 1 });
        ADF_TAU_MAX.put(RegressionMethod.ct, new double[] { 0.7, 0.63, 0.71, 0.93, 1.19, 1.42 });
        ADF_TAU_MAX.put(RegressionMethod.ctt, new double[] { 0.54, 0.79, 1.08, 1.43, 3.49, 1.92 });

        ADF_TAU_SMALLP.put(RegressionMethod.nc,
        ...
        ADF_TAU_SMALLP.put(RegressionMethod.c,
        ...
        ADF_TAU_SMALLP.put(RegressionMethod.ct,
        ...
        ADF_TAU_SMALLP.put(RegressionMethod.ctt,
        ...
        ADF_TAU_LARGEP.put(RegressionMethod.nc,
        ...
        ADF_TAU_LARGEP.put(RegressionMethod.c,
        ...
        ADF_TAU_LARGEP.put(RegressionMethod.ct,
        ...
        ADF_TAU_LARGEP.put(RegressionMethod.ctt,
        ...
        for (final double[][] arr : ADF_TAU_LARGEP.values()) {
