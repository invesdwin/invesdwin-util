...
import de.invesdwin.util.streams.buffer.extend.internal.UninitializedExpandableDirectBuffer;

@NotThreadSafe
public class DirectExpandableByteBuffer extends UninitializedExpandableDirectBuffer implements IByteBuffer {
