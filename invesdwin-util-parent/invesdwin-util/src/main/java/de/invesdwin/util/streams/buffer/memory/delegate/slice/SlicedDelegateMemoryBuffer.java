...
@NotThreadSafe
public class SlicedDelegateMemoryBuffer implements IMemoryBuffer {
    ...
    public SlicedDelegateMemoryBuffer(final IMemoryBuffer delegate, final long from, final long length) {
