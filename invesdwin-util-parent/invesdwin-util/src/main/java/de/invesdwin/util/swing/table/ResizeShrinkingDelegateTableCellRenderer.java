...
/**
 * This table cell renderer can both increase and decrease the width of columns, the user can not manually adjust the
 * column size, thus "tbl_rows.getTableHeader().setResizingAllowed(false);" should be used so that the cursor does not
 * indicate that resizing is possible.
 */
@NotThreadSafe
public class ResizeShrinkingDelegateTableCellRenderer implements TableCellRenderer {
    ...
    public ResizeShrinkingDelegateTableCellRenderer(final TableCellRenderer delegate) {
