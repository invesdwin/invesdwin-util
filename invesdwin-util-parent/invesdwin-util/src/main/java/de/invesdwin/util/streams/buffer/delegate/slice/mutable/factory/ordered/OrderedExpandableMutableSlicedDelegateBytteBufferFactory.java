...
@NotThreadSafe
public class OrderedExpandableMutableSlicedDelegateBytteBufferFactory implements IMutableSlicedDelegateByteBufferFactory {
    ...
    public OrderedExpandableMutableSlicedDelegateBytteBufferFactory(final IByteBuffer delegate, final ByteOrder order) {
