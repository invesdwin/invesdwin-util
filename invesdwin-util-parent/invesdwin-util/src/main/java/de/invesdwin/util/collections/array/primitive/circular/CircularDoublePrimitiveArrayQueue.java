 ...
 */
@NotThreadSafe
public class CircularDoublePrimitiveArrayQueue implements IDoubleQueue, IDoublePrimitiveArrayAccessor {
    ...
    public CircularDoublePrimitiveArrayQueue(final int capacity) {
